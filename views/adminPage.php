      ...
      <div class="row">
        ...
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            ?>
       <!-- foreach fournit une façon simple de parcourir des tableaux. foreach ne fonctionne que pour les tableaux 
            et les objets. De plus, on utilise foreach quand on ne connait pas la taille du tableau que l'on veut parcourir.  -->
          </tbody>
        </table>
      </div>
    </div> 
