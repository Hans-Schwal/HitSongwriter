...
class admin extends database {
  ...
  /**
   * La methode suivante permet d'afficher les valeurs de ma table users, en fonction du mail renseigné , 
   * grâce à une requete préparée.
   * 
   * @return type
   */
  public function showUsers(){
    $query = "SELECT `lastName`,`firstName`,`userName`,`mail` FROM `users` WHERE '$this->mail'";
